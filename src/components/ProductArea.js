  ...
  if (Array.isArray(props.Products) && props.Products.length) {
    return (
      <div className={styles.ProductArea}>
        <div className={styles.ProductAreaTitle}>Shopping Cart</div>
        ...
        <div className={styles.ProductTotal}>Total cost of all products: {props.ProductCosts} €</div>
      </div>
    );
  } else {
    return (
      <div className={styles.ProductArea}>
        <div className={styles.ProductAreaTitle}>Shopping Cart</div>
        <div className={styles.EmptyMessage}>Your shopping cart is currently empty</div>
      </div>
    );
  }
};
